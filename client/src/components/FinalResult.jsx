...
function FinalResult({ result }) {
  ...
  return (
    <div className="mt-6 p-3 space-y-10 bg-white">
        ...
        {/* // showing two buttons  quickRevision and Download PDF */}
        ...
        {/* for showing the Priority wise topic name  */}
        ...
        {/* for showing Exam Quick Revision Points  */}
        ...
        {/* for showing the charts using the  */}
        ...
        {/* for showing the Short and Long questions */}
        <section>
